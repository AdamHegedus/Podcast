...
public class ChannelType {
	 ...
	 *
	 * @param lastBuildDate
	 *            the podcast's last modification date and time
	 */
	 ...
	 *
	 * @param ttl
	 *            the minutes of how long the channel should be cached before
	 *            updating
	 */
	 ...
	 *            the value should be "clean" or "yes"
	 */
